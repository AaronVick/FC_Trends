...
/*!******************************!*\
  ...
  \******************************/(e,t,n)=>{"use strict";n.r(t),n.d(t,{DEVICE_TYPES:()=>s});const s=Object.freeze({cpu:"cpu",gpu:"gpu",wasm:"wasm",webgpu:"webgpu",cuda:"cuda",dml:"dml"})},"./src/utils/dtypes.js":
/*!*****************************!*\
  !*** ./src/utils/dtypes.js ***!
  \*****************************/(e,t,n)=>{"use strict";n.r(t),n.d(t,{DATA_TYPES:()=>i,DEFAULT_DEVICE_DTYPE_MAPPING:()=>a,DEFAULT_DTYPE_SUFFIX_MAPPING:()=>l,isWebGpuFp16Supported:()=>o});var s=n(/*! ../env.js */"./src/env.js"),r=n(/*! ./devices.js */"./src/utils/devices.js");const o=function(){let e;return async function(){if(void 0===e)if(s.apis.IS_WEBGPU_AVAILABLE)try{const t=await navigator.gpu.requestAdapter();e=t.features.has("shader-f16")}catch(t){e=!1}else e=!1;return e}}(),i=Object.freeze({fp32:"fp32",fp16:"fp16",q8:"q8",int8:"int8",uint8:"uint8",q4:"q4",bnb4:"bnb4",q4f16:"q4f16"}),a=Object.freeze({[r.DEVICE_TYPES.cpu]:i.q8,[r.DEVICE_TYPES.gpu]:i.fp32,[r.DEVICE_TYPES.wasm]:i.q8,[r.DEVICE_TYPES.webgpu]:i.fp32,[r.DEVICE_TYPES.cuda]:i.fp32,[r.DEVICE_TYPES.dml]:i.fp32}),l=Object.freeze({[i.fp32]:"",[i.fp16]:"_fp16",[i.int8]:"_int8",[i.uint8]:"_uint8",[i.q8]:"_quantized",[i.q4]:"_q4",[i.q4f16]:"_q4f16",[i.bnb4]:"_bnb4"})},"./src/utils/generic.js":
/*!******************************!*\
